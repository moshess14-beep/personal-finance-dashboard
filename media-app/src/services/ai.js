...
{"category":"book|movie|series|artist|show|music|${genericEnum}unknown",
...
כללי סיווג: ספר=book, סרט=movie, סדרת טלוויזיה=series, המלצה על אמן/זמר/להקה חדשים לגילוי (בלי אירוע קונקרטי)=artist, כרטיס/פרסום להופעה קונקרטית עם תאריך — קונצרט, הצגת תיאטרון, הקרנת קולנוע, סטנדאפ, מחול=show, שיר/אלבום/פודקאסט להאזנה (למשל צילום מסך מספוטיפיי/יוטיוב מיוזיק)=music.
